...
# Project Description 📝
StudyBuddy is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [StudyBuddy Aim](#StudyBuddy-aim-)        | 📚 Overview of StudyBuddy's goals            |
...
## System Architecture 🏰
<br/>
☝ The StudyBuddy ed-tech platform consists of three main components:  <br/>
...
<br/>
Here is a high-level diagram that illustrates the architecture of the StudyBuddy ed-tech platform:
...
#### The front end of StudyBuddy has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Cloud-based Media Management ☁️ :** StudyBuddy uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of StudyBuddy uses several data models and database schemas to manage data, including:
